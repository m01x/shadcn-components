...
const links = [
  ...
  { name: "tabs", href: "tabs" },
  { name: "data-table", href: "datatable" },
  { name: "form", href: "form" },
          ...
          <footer className="bg-white md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 mx-4 print:hidden dark:bg-slate-600">
            <ul className="flex items-center flex-wrap mb-6 md:mb-0">
              <li>
                <a
                  href="#"
                  className="text-sm font-normal text-gray-500 hover:underline mr-4 md:mr-6 dark:text-slate-300"
                >
              ...
              <li>
                <a
                  href="#"
                  className="text-sm font-normal text-gray-500 hover:underline dark:text-slate-300"
                >
                  Contact
                </a>
              </li>
            ...
            <div className="flex sm:justify-center space-x-6">
              <a href="#" className="text-gray-500 hover:text-gray-900 dark:text-slate-300">
                <svg
                  className="h-5 w-5"
                  fill="currentColor"
                  viewBox="0 0 24 24"
